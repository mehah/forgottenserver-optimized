...
-- levels: 0(off), 1(best speed) - 9(best compression)
...
mysqlUser = 'root'
mysqlPass = ''
mysqlDatabase = 'forgottenserver-optimized'
mysqlPort = 3306
mysqlSock = ''
...
-- Store
storeUrl = 'https://raw.githubusercontent.com/opentibiabr/store/master/'
storeCoinPackages = 25 -- transferable coin packages

-- Tracked Quests
maxTrackedQuests = 10
maxTrackedQuestsPremium = 25
