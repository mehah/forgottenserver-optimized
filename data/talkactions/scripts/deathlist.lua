    ...
    if resultId ~= false then
        ...
        if resultId ~= false then
            repeat
                ...
                str = str .. breakline .. ' ' .. date.day .. getMonthDayEnding(date.day) .. ' ' ..
                          getMonthString(date.month) .. ' ' .. date.year .. ' ' .. date.hour .. ':' .. date.min .. ':' ..
                          date.sec .. '   Died at Level ' .. result.getDataInt(resultId, 'level') .. ' by ' .. article ..
                          killed_by .. '.'
