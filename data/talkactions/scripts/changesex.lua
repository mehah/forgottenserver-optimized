...
function onSay(player, words, param)
    ...
    if player:getPremiumDays() >= premiumDaysCost then
        ...
        player:sendTextMessage(MESSAGE_INFO_DESCR,
                               'You have changed your sex for ' .. premiumDaysCost .. ' days of your premium account.')
    else
        player:sendCancelMessage('You do not have enough premium days, changing sex costs ' .. premiumDaysCost ..
