function onLogin(player)
    ...
    if table.contains({SKILL_CLUB, SKILL_SWORD, SKILL_AXE, SKILL_DISTANCE}, offlineTrainingSkill) then
        ...
        updateSkills = player:addOfflineTrainingTries(offlineTrainingSkill, (trainingTime / modifier) /
    ...
    elseif offlineTrainingSkill == SKILL_MAGLEVEL then
        ...
        updateSkills = player:addOfflineTrainingTries(SKILL_MAGLEVEL,
                                                      trainingTime * (vocation:getManaGainAmount() / gainTicks))
    end
