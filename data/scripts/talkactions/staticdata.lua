                ...
                if file then
                    ...
                    for i = 1, #monsters do
                        ...
                        if monster.outfit.looktype == 0 then
                            file:write(
                                '\n<monster id="' .. monster.id .. '" name="' .. monster.name .. '" looktypeex="' ..
                                    (monster.outfit.lookhead > 0 and monster.outfit.lookhead or monster.outfit.lookbody >
                                        0 and monster.outfit.lookbody or monster.outfit.looklegs > 0 and
                                        monster.outfit.looklegs or monster.outfit.lookfeet) .. '" addons="' ..
                                    monster.outfit.lookaddons .. '" />')
                        else
                            file:write(
                                '\n<monster id="' .. monster.id .. '" name="' .. monster.name .. '" looktype="' ..
                                    monster.outfit.looktype .. '" head="' .. monster.outfit.lookhead .. '" body="' ..
                                    monster.outfit.lookbody .. '" legs="' .. monster.outfit.looklegs .. '" feet="' ..
                                    monster.outfit.lookfeet .. '" addons="' .. monster.outfit.lookaddons .. '" />')
                        end
                    end
                    ...
                    for i = 1, #houses do
                        ...
                        if house.description and house.description:len() > 0 then
                            file:write('\n<house id="' .. house.id .. '" name="' .. house.name .. '" city="' ..
                                           house.city .. '" description="' .. house.description .. '" x="' ..
                                           house.position.x .. '" y="' .. house.position.y .. '" z="' ..
                                           house.position.z .. '" rent="' .. house.rent .. '" sqms="' .. house.SQMs ..
                                           '" beds="' .. house.beds .. '" guildHall="' ..
                                           (house.isGuildHall and 'yes' or 'no') .. '" shop="' ..
                                           (house.isShop and 'yes' or 'no') .. '" />')
                        else
                            file:write('\n<house id="' .. house.id .. '" name="' .. house.name .. '" city="' ..
                                           house.city .. '" x="' .. house.position.x .. '" y="' .. house.position.y ..
                                           '" z="' .. house.position.z .. '" rent="' .. house.rent .. '" sqms="' ..
                                           house.SQMs .. '" beds="' .. house.beds .. '" guildHall="' ..
                                           (house.isGuildHall and 'yes' or 'no') .. '" shop="' ..
                                           (house.isShop and 'yes' or 'no') .. '" />')
                        end
                    end
