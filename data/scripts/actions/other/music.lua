local instruments = {
    ...
    [2077] = {
        effect = CONST_ME_SOUND_GREEN,
        client_version = 0
    }, -- royal fanfare (actual effect is unknown)
    [2078] = {
        effect = CONST_ME_SOUND_GREEN,
        client_version = 0
    }, -- post horn
    ...
    [2080] = {
        ...
        client_version = 0
    }, -- piano (actual effect is unknown)
    [2081] = {
        effect = CONST_ME_SOUND_BLUE,
        client_version = 0
    }, -- piano
    ...
    [2332] = {
        effect = CONST_ME_SOUND_BLUE,
        client_version = 0
    }, -- Waldo's post horn (actual effect is unknown)
    [2364] = {
        effect = CONST_ME_SOUND_GREEN,
        client_version = 0
    }, -- post horn
    ...
    [2371] = {
        effect = CONST_ME_SOUND_BLUE,
        client_version = 0
    }, -- the horn of sundering (actual effect is unknown; immovable)
    [2372] = {
        effect = CONST_ME_SOUND_GREEN,
        client_version = 0
    }, -- lyre (immovable)
    ...
    [2374] = {
        effect = CONST_ME_SOUND_GREEN,
        client_version = 0
    }, -- wooden flute (immovable)
    [3951] = {
        effect = CONST_ME_SOUND_BLUE,
        client_version = 750
    }, -- bongo drum (actual effect is unknown)
    [3952] = {
        effects = {
            failure = CONST_ME_POFF,
            success = CONST_ME_SOUND_GREEN
        },
        chance = 20,
        client_version = 750
    }, -- didgeridoo
    ...
    [5786] = {
        effects = {
            failure = CONST_ME_SOUND_RED,
            success = CONST_ME_SOUND_YELLOW
        },
        monster = 'war wolf',
        chance = 60,
        remove = true,
    ...
    [13759] = {
        effect = CONST_ME_SOUND_BLUE,
        client_version = 910
    }, -- small whistle (actual effect is unknown)
    [23923] = {
...
function music.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    ...
    item:getPosition():sendMagicEffect(
        instrument.effect or instrument.effects and chance and instrument.effects.success or instrument.effects.failure)
