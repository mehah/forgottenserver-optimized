...
for _, d in ipairs(questDoors) do
    if doorsSet[d] == nil then
        doorsSet[d] = true
    end
end
for _, d in ipairs(levelDoors) do
    if doorsSet[d] == nil then
        doorsSet[d] = true
    end
end
...
for _, d in ipairs(horizontalOpenDoors) do
    if doorsSet[d] == nil then
        doorsSet[d] = true
    end
end
for _, d in ipairs(verticalOpenDoors) do
    if doorsSet[d] == nil then
        doorsSet[d] = true
    end
end
