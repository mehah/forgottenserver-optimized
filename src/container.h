...
private:
    ...
    void onAddContainerItem(const Item* item) const;
    void onUpdateContainerItem(uint32_t index, const Item* oldItem, const Item* newItem) const;
    void onRemoveContainerItem(uint32_t index, const Item* item) const;
