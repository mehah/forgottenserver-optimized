...
public:
    ...
    void setDoorId(const uint32_t doorId) {
...
public:
    ...
    bool kickPlayer(const Player* player, Player* target);
    ...
    bool executeTransfer(const HouseTransferItem* item, const Player* newOwner);
...
public:
    ...
    House* getHouse(const uint32_t houseId) {
